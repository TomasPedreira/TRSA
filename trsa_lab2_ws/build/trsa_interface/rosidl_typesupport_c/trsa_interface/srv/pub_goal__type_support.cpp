...
static const _PubGoal_Request_type_support_symbol_names_t _PubGoal_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, trsa_interface, srv, PubGoal_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, trsa_interface, srv, PubGoal_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, trsa_interface, srv, PubGoal_Request)() {
  return &::trsa_interface::srv::rosidl_typesupport_c::PubGoal_Request_message_type_support_handle;
}
...
static const _PubGoal_Response_type_support_symbol_names_t _PubGoal_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, trsa_interface, srv, PubGoal_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, trsa_interface, srv, PubGoal_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, trsa_interface, srv, PubGoal_Response)() {
  return &::trsa_interface::srv::rosidl_typesupport_c::PubGoal_Response_message_type_support_handle;
}
...
static const _PubGoal_type_support_symbol_names_t _PubGoal_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, trsa_interface, srv, PubGoal)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, trsa_interface, srv, PubGoal)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, trsa_interface, srv, PubGoal)() {
  return &::trsa_interface::srv::rosidl_typesupport_c::PubGoal_service_type_support_handle;
}
